...
//
// CJSortClass.cpp: implementation of the CSortClass class.
//
/////////////////////////////////////////////////////////////////////////////
...
CSortClass::CSortClass(CListCtrl* pWnd, const int nCol)
{
	ASSERT(pWnd);
	m_pWnd = pWnd;
...
void CSortClass::Sort(bool bAsc, DATA_TYPE eType)
{
